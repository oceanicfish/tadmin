 ...
 */
var app = angular.module('recordtApp', []);

app.controller('recordtController',[ '$http', function($http){
    ...
    ds.students = [];
    ds.clength = 1;
    ds.teacherName = angular.element("#teacherName").val();
    ds.tid = angular.element("#tid").val();
